                    ...
                    <div className='w-full xl:px-[30px]'>
                        ...
                        <ComponentsCode id='link' ref={registerRef('link')} codeArr={[BTN_LINK_USAGE_CODE]}>
                            ...
                            <Text>
                                ...
                                <span className='badge-item'>Btn.Link</span> child component to make another component
                                look like a button. Here's an example of a link that looks like a button.
                            </Text>
                        </ComponentsCode>
