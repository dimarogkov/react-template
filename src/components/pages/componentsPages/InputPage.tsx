import { INPUT_CODE, INPUT_DEMO_CODE, INPUT_USAGE_CODE, INPUT_CONTROLLED_USAGE_CODE } from '../../../variables/code';
import {
    ...
    const codeSections: IDocumentationCodeSection[] = [
        {
            id: 'code',
            title: 'Code',
            link: 'https://github.com/dimarogkov/react-template/blob/master/src/components/ui/Input.tsx',
            description: (
                <Text>
