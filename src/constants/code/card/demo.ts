export const CARD_DEMO_CODE = `import { Btn, Card, Input, Label, Text, Title } from '@components/atoms';
...
export const CardDemo = () => {
  return (
    <div className='relative grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-4 w-full'>
      ...
      <Card className='grid grid-cols-1 sm:grid-cols-[40%_auto] items-end md:col-span-2'>
