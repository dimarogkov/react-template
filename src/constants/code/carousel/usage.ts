...
export const CAROUSEL_SIZES_USAGE_CODE = `import useEmblaCarousel from 'embla-carousel-react';
...
export const CAROUSEL_SPACING_USAGE_CODE = `import useEmblaCarousel from 'embla-carousel-react';
import { EmblaOptionsType } from 'embla-carousel';
import { Carousel } from '@components/atoms';
...
export const CAROUSEL_BTNS_USAGE_CODE = `import useEmblaCarousel from 'embla-carousel-react';
import { EmblaOptionsType } from 'embla-carousel';
...
export const CAROUSEL_DOTS_USAGE_CODE = `import useEmblaCarousel from 'embla-carousel-react';
import { EmblaOptionsType } from 'embla-carousel';
import { useCarousel } from '@hooks';
import { Carousel } from '@components/atoms';
