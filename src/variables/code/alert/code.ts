...
export const AlertWrapper: FC<Props> = forwardRef<HTMLDivElement, Props>(
...
export const ALERT_TITLE_CODE = `import { FC, forwardRef, HTMLAttributes, RefAttributes } from 'react';
